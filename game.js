// --- Game.js for GitHub Pages (no imports) ---

let scene, camera, renderer;
let world, ballBody, carBody;
let carMesh, ballMesh;
...
function init() {
    ...
    ballMesh = new THREE.Mesh(ballGeo, new THREE.MeshStandardMaterial({color:0xffff00}));
    ...
    carMesh = new THREE.Mesh(carGeo, new THREE.MeshStandardMaterial({color:0xff0000}));
...
function animate(){
    ...
    camera.position.z = carMesh.position.z + 20;
    camera.position.y = carMesh.position.y + 10;
